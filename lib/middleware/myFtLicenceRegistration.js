...
function checkAndRegister(req, res, next, runInBackground) {
...
function _register(licenceId, currentUserId, licenceData) {
  ...
  return new Promise(resolve => {
    ...
    .then(relationData => {
      ...
      if (relationData.license && relationData.license.properties && relationData.license.properties.uuid === licenceId) {
