...
function getUserId (req, res, next) {
	...
	if (res.locals.flags.kat2fa) { //TODO delete this block when 2fa becomes default in next major version
		...
		if (!!secureSessionToken) {
			...
			return sessionClient.verify(secureSessionToken, {flags: res.locals.flags})
				.then(result => {
