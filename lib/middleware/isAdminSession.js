...
function getAdminUserList(req, res, next) {
    ...
    accessLicenceClient.getAdministrators(req.licenceId)
        .then(result => {
...
function isAdminUser(req, res, next) {
    ...
    getListOfLicences(req)
        .then(() => {
            if (req.session.isPopulated && Array.isArray(req.listOfLicences) && isLicenceInList(req.listOfLicences, req.licenceId)) {
