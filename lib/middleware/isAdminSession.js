...
function* isAdminUser(req, res, next) {
    ...
    try {
      ...
      if (req.kmtSession) {
        ...
        const adminUserList = yield accesslicenceService.getAdministrators('5589c139-f49e-4344-8132-c51aadda7a8b');
        ...
        const currentUser = req.currentUser.uuid;
         ...
         logger.info({operation:'isAdminUser', forLicence:req.params.licenceId, user:req.currentUser.uuid});
         if (adminUsers.some(user => user.userId === currentUser)) {
